...
from transformers.models.llama.modeling_llama import LlamaForCausalLM, LlamaModel, LlamaAttention, apply_rotary_pos_emb, repeat_kv
...
# class LlamaLoraFlashDiffAttention(LlamaAttention):
#     """
#     Multi-headed differential attention using flash-attention https://github.com/Dao-AILab/flash-attention
#     from 'Differential Transformer' paper: https://arxiv.org/abs/2410.05258
#     """
...
#         ### CODE FROM transformers > LlamaFlashAttention2 ###
...
#         value_states = value_states.transpose(1, 2)  # [bsz, self.num_heads, total_q_len, self.head_dim] -> [bsz, total_q_len, self.num_heads, self.head_dim]
...
class LlamaLoraDiffTransformerForCausalLM(LlamaForCausalLM):
    # edit __init__ to change self.model to LlamaLoraDiffTransformerModel and freeze params
